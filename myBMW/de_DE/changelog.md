...
Folgende Korrekturen:
 - MQTT-Bugfix – Unterstützung der neuen Deskriptoren „vehicle.body.chargingPort.status“, „vehicle.drivetrain.electricEngine.kombiRemainingElectricRange“ und „vehicle.drivetrain.electricEngine.charging.timeToFullyCharged“
 - Aktualisierung des Telematik-Katalogs (derzeit 258 Einträge)
 
Benutzer, die den „Container“ nach dem 1. Juli 2026 erstellt haben, bitte ich, diesen zu löschen (Seite „Ausstattung“) und eine vollständige Authentifizierung durchzuführen, um den neuen Katalog zu berücksichtigen.
