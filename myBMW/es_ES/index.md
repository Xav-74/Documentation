...
3. Haz clic en el icono **BMW CarData**

![CarData](../images/CarData_section.png)

4. Haz clic en el botón **«Crear un cliente CarData»**
5. ¡Anota **el ID de cliente** en un lugar seguro!
...
12. Selecciona **manualmente** los 244 atributos individuales o pulsa F12 para acceder a la **consola de desarrollador** y escribe: (no se puede copiar y pegar)
```
document.querySelectorAll('label.chakra-checkbox:not([data-checked])').forEach(l => l.click());
```
14. A continuación, **guarda** tu configuración
15. ¡Anota **el nombre de usuario** en un lugar seguro!

**Es importante que se marquen todos los atributos para recibir todos los datos del vehículo.**
...
-   **VIN**: introduce el número VIN o Vehicle Identification Number (número de identificación del vehículo). Encontrarás este número en la casilla E de tu permiso de circulación. Este número consta de 17 caracteres.
-   **Visualización del estado de puertas y ventanas**: puedes elegir entre dos opciones para visualizar el estado de las puertas y ventanas en el panel: el modo de texto o el modo de iconos.
...
-   **Domicilio (presencia)**: dispone de tres opciones para indicar las coordenadas GPS de su domicilio: bien utilizando las coordenadas introducidas en Jeedom, bien utilizando las coordenadas actuales del vehículo, bien introduciendo manualmente la latitud y la longitud.
...
-   **Estado de la puerta del conductor delantera**
...
-   **Estado de la ventanilla del acompañante trasero**
...
-   **Instrucciones para inflar el neumático delantero izquierdo**
-   **Presión del neumático delantero derecho**
-   **Instrucciones para inflar el neumático delantero derecho**
...
-   **Estado del enchufe** (solo en vehículos eléctricos o híbridos)
...
-   **Sesiones de carga**: recoge las estadísticas de carga eléctrica de las baterías durante el mes en curso (solo en vehículos eléctricos o híbridos)
-   **Consumo eléctrico total**: indica el consumo eléctrico total del mes en curso (solo en vehículos eléctricos o híbridos)
...
-   **Límite de corriente de carga**: indica el límite de la corriente de carga utilizada cuando el vehículo está enchufado
...
-   **Coordenadas GPS**: muestra la posición del vehículo en el formato «latitud, longitud»
...
-   **Estado: Bloqueado**
-   **Estado: Cargando**
-   **Estado «Detener carga»**
-   **Estado: Ventilar**
-   **Estado «Detener ventilación»**
-   **Estado «Luces de carretera»**
-   **Estado: Tocar la bocina**
-   **Estado: Buscar**
-   **Estado del envío de POI**
...
-   **Carga**: permite iniciar la carga del vehículo
...
-   **Ventilación (Stop)**: permite detener el sistema de ventilación a la temperatura ajustada en el vehículo
-   **Mezcla de luces**: activa la mezcla de luces
...
También se crea una tarea CRON personalizable (cada 2 horas, 5 minutos después de la hora) para recuperar la información que no se puede transmitir en tiempo real (mensajes de control, de servicios, historial de carga). ¡Ten cuidado de no aumentar demasiado esta frecuencia, ya que podrías superar los límites de solicitudes permitidos por BMW (50 al día)!
