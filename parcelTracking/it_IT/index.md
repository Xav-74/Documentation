...
Questo plugin ti permette di tracciare i tuoi pacchi provenienti dai principali corrieri francesi e internazionali (La Poste, Mondial Relay, Relais Colis, Colis Privé, Aliexpress, Shein, Amazon, eBay, FedEx, UPS, ...) tramite l'API di [**17Track**](https://www.17track.net/en).<br/>
...
Funzionano così: nome_da_seguire=#name# dove nome_da_seguire è il nome del tag e #name# è il valore del tag
12. Inserisci le impostazioni del widget
...
<br/>![Configurazione parcelTracking](../images/eqt_parcelTracking.png)<br/>
...
In ogni caso, è possibile eliminare i pacchi (icona <img src="../images/trash-solid.svg" width="15" height="15">) o aggiungerne uno nuovo (icona <img src="../images/plus-solid.svg" width="15" height="15">) direttamente dai widget.

**Attenzione:** Il widget unico è visibile nella pagina delle apparecchiature del plugin. Non deve essere eliminato in nessun caso. Se dovesse essere eliminato per errore, è sufficiente forzare una reinstallazione del plugin (senza perdita di dati) e il widget verrà ricreato.
...
> **Suggerimento**
>
>Potete inviare la vostra richiesta di miglioramento creando un issue "enhancement" su [GitHub](https://github.com/Xav-74/parcelTracking/issues/new).
