...
Este plugin permite-lhe acompanhar as suas encomendas provenientes das principais transportadoras francesas e internacionais (La Poste, Mondial Relay, Relais Colis, Colis Privé, Aliexpress, Shein, Amazon, eBay, FedEx, UPS, ...) através da API do [**17Track**](https://www.17track.net/en).<br/>
...
> O plugin já é compatível com as **versões Debian 11 e 12**
...
<br/><br/>![Painel de controlo 17Track](../images/dashboard_17Track.png)<br/><br/>
...
Funcionam da seguinte forma: nome-da-tag=#name#, em que «nome-da-tag» é o nome da tag e #name# é o valor da tag
12. Preencha os parâmetros do widget
3 opções possíveis:
...
<br/>![Configuração do acompanhamento de encomendas](../images/config_parcelTracking.png)<br/>
...
<br/>![Configuração do parcelTracking](../images/eqt_parcelTracking.png)<br/>
...
- **Estado da encomenda**: 5 estados possíveis (entregue, em trânsito, a recolher, chegada, arquivada)
...
Em qualquer caso, pode eliminar as encomendas (ícone <img src="../images/trash-solid.svg" width="15" height="15">) ou adicionar uma nova (ícone <img src="../images/plus-solid.svg" width="15" height="15">) diretamente a partir dos widgets.

**Atenção:** O widget único está visível na página de equipamentos do plugin. Não deve, em caso algum, ser eliminado. Se for eliminado por engano, basta forçar a reinstalação do plugin (sem perda de dados) e este será recriado.
...
- Configuração de um WebHook para a receção de dados em tempo real
- ...

> **Dica**
>
>Pode enviar o seu pedido de melhoria criando um «issue» de «melhoria» no [GitHub](https://github.com/Xav-74/parcelTracking/issues/new).
