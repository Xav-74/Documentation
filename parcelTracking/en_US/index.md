...
This plugin lets you track your packages from major French and international carriers (La Poste, Mondial Relay, Relais Colis, Colis Privé, AliExpress, Shein, Amazon, eBay, FedEx, UPS, etc.) via the [**17Track**](https://www.17track.net/en) API.<br/>
...
<br/><br/>![17Track Dashboard](../images/dashboard_17Track.png)<br/><br/>

6. Also fill out the Webhook section as follows: ("jeedom-host" is the external address of your device)
<br/><br/>![17Track Webhook](../images/webhook_17Track.png)<br/><br/>
...
Here's how they work: trackname=#name#, where trackname is the tag name and #name# is the tag value
12. Enter the widget settings
3 options:
...
<br/>![ParcelTracking configuration](../images/config_parcelTracking.png)<br/>
...
<br/>![Parcel Tracking Configuration](../images/eqt_parcelTracking.png)<br/>
...
- **Origin**: the country of origin of the package
- **Destination**: country where the package is being sent
- **Stages**: list of all delivery stages
- **Last Event**: Date and time of the last event sent by the carrier. Used for sending notifications
- **Latest Status**: The latest status sent by the carrier. Used for sending notifications
...
In any case, you can delete packages (icon <img src="../images/trash-solid.svg" width="15" height="15">) or add a new one (icon <img src="../images/plus-solid.svg" width="15" height="15">) directly from the widgets.

**Note:** The single widget is visible on the plugin's devices page. Under no circumstances should it be deleted. If it is deleted by mistake, simply force a reinstallation of the plugin (no data will be lost), and it will be recreated.
...
> **Tip**
>
>You can submit your enhancement request by creating an "enhancement" issue on [GitHub](https://github.com/Xav-74/parcelTracking/issues/new).
