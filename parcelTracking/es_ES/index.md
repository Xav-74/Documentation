...
Este complemento te permite realizar el seguimiento de tus paquetes de las principales empresas de transporte francesas e internacionales (La Poste, Mondial Relay, Relais Colis, Colis Privé, Aliexpress, Shein, Amazon, eBay, FedEx, UPS, etc.) a través de la API de [**17Track**](https://www.17track.net/en).<br/>
...
<br/><br/>![Panel de control de 17Track](../images/dashboard_17Track.png)<br/><br/>
...
Funcionan así: nombre_del_seguimiento=#name#, donde nombre_del_seguimiento es el nombre de la etiqueta y #name# el valor de la etiqueta
12. Introduce los parámetros del widget
3 opciones posibles:
...
<br/>![Configuración de seguimiento de paquetes](../images/config_parcelTracking.png)<br/>
...
> **Consejo**
>
>Si, tras el primer registro **correcto**, necesitas modificar el transportista y/o el parámetro adicional, puedes hacerlo mediante los botones de actualización. Atención: a veces ocurre que, tras actualizar uno de los dos parámetros, la información de seguimiento no se actualiza de inmediato. Espere entre 1 y 2 horas. Transcurrido ese tiempo, es preferible eliminar el envío y volver a crearlo **con todos los parámetros actualizados desde el primer registro**.

<br/>![Configuración de seguimiento de paquetes](../images/eqt_parcelTracking.png)<br/>
...
- **Estados**: lista de todas las etapas del envío
...
En cualquier caso, tienes la posibilidad de eliminar paquetes (icono <img src="../images/trash-solid.svg" width="15" height="15">) o añadir uno nuevo (icono <img src="../images/plus-solid.svg" width="15" height="15">) directamente desde los widgets.

**Atención:** El widget único aparece en la página de dispositivos del complemento. No debe eliminarse bajo ningún concepto. Si se elimina por error, basta con forzar una reinstalación del complemento (sin pérdida de datos) y se volverá a crear.
