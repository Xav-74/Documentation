...
Este token é válido por 90 dias. O Jeedom irá avisá-lo quando for necessário renová-lo manualmente
...
![Configuração do InstantInk](../images/config_instantInk.png)
...
![Equipamento InstantInk](../images/eqt_instantInk.png)
...
| **Número máximo de páginas a reportar** | o número máximo de páginas reportadas de um período para outro |
| **Preço do plano** | o preço mensal do seu plano |
| **Número máximo de páginas adicionais no plano** | o número máximo de páginas autorizadas no modo fora do plano |
| **Período** | o período atual do plano |
| **Número de páginas impressas no período** | o número de páginas impressas durante o período |
| **Número de páginas impressas no período em análise** | o número de páginas impressas no período em análise |
...
| **Última atualização** | data e hora da última atualização das informações |
| **Histórico** | todas as informações relativas ao plano (páginas impressas e preços) dos últimos 12 meses |

> **Dica**
>
> Se não quiser que o histórico seja apresentado no widget, basta desmarcar a caixa de seleção **Mostrar** desta opção.
...
Tem a possibilidade de atualizar as informações (ícone <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-2px"><path d="M21 12a9 9 0 1 1-2.64-6.36"/><path d="M21 3v6h-6"/></svg>) ou o histórico (ícone <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-2px"><path d="M3 3v18h18"/><path d="M7 16v2M12 11v7M17 7v11"/></svg>) diretamente a partir do widget.
