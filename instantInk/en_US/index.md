...
<br/>This token is valid for 90 days. Jeedom will notify you when you need to renew it manually.
...
<br/>![InstantInk configuration](../images/config_instantInk.png)<br/>
...
<br/>![InstantInk equipment](../images/eqt_instantInk.png)<br/>
...
- **Maximum number of pages to carry forward**: the maximum number of pages that can be carried forward from one period to the next
- **Plan price**: the monthly price of your plan
- **Maximum number of additional pages in mode**: the maximum number of pages allowed in mode
...
- **Number of additional pages printed during the period**: the number of pages printed beyond the plan’s allowance during the period
- **Period Price**: the current price for the period
- **Black Cartridge Status**: The current ink level of the black cartridge (%)
- **Cyan Cartridge Status**: Current ink level of the cyan cartridge (%)
- **Magenta Cartridge Status**: The current ink level of the magenta cartridge (%)
- **Yellow Cartridge Status**: the current ink level of the yellow cartridge (%)
...
- **Refresh**: Updates all information about the printer and the plan
- **View History**: Allows you to view your plan history for the past 12 months
...
You can refresh the information (icon <i class="fas fa-sync" style="width:15px; height:15px"></i>) or the history (icon <i class="far fa-chart-bar" style="width:15px; height:15px"></i>) directly from the widget.
...
> **Tip**
>
>You can submit your enhancement request by creating an "enhancement" issue on [GitHub](https://github.com/Xav-74/instantInk/issues/new).
